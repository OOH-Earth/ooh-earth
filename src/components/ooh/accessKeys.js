...
export const ACCESS_KEYS = {
  '4-way-utility': {
    label: '4-Way Utility Key',
    blurb: '4-way utility wrench — opens many transit-shelter and poster-housing cam locks.',
  },
  ...
  'circle-set': {
    label: 'Circle Set',
    blurb: 'Multi-pin circle barrel variant for shelter housings.',
  },
  ...
  'large-square': {
    label: 'Large Square',
    blurb: 'Square socket key for larger shelter housings.',
  },
  'small-square': {
    label: 'Small Square',
    blurb: 'Square socket key for smaller shelter housings.',
  },
  't-handle': { label: 'T-Handle', blurb: 'T-handle wrench for rotary cam locks.' },
  tx30: {
    label: 'TX30',
    blurb: 'Torx T30 key with a hole in the end — used on some JCDecaux/Cemusa shelters.',
  },
  tri38: {
    label: 'TRI38',
    blurb: '10mm triangular key common on continental European transit shelters and Adshel units.',
  },
