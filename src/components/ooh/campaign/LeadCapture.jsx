...
export default function LeadCapture() {
  ...
  const inputCls = "w-full bg-void border border-slate2 px-4 py-3 font-display text-sm text-silver outline-none transition-all placeholder:text-dim focus:border-ozone focus:shadow-[0_0_0_1px_rgba(237,255,0,0.2)]";

  return (
    <form onSubmit={submit} className="space-y-4 overflow-hidden border border-slate2/60 bg-card p-4 md:p-6">
