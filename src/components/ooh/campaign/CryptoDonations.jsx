...
const CHAINS = [
  ...
  { key: "usdc", label: "USDC", ticker: "USDC" },
  { key: "polygon", label: "Polygon", ticker: "POL" },
];
    ...
    <div className="border border-slate2/60 bg-card p-6">
      ...
      <div className="mt-4 space-y-2">
        {available.length ? available.map((c) => (
          <div key={c.key} className="flex items-center gap-2 border border-slate2/50 bg-void p-3">
