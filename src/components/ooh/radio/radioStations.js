...
export const RADIO_STATIONS = [
  // ── NEWS ───────────────────────────────────────────────
  {
    ...
    genre: 'Global News',
    category: 'news',
    stream: 'http://npr-ice.streamguys1.com/live.mp3',
    city: 'Washington',
    country: 'USA',
    lat: 38.9072,
    lng: -77.0369,
  ...
  },
  {
    ...
    genre: 'Global News',
    category: 'news',
    stream: 'https://tunein.cdnstream1.com/2868_96.mp3',
    city: 'Atlanta',
    country: 'USA',
    lat: 33.749,
    lng: -84.388,
  },
  {
    ...
    genre: 'News · Politics',
    category: 'news',
    stream: 'https://live.amperwave.net/direct/foxnewsradio-foxnewsradioaac-imc?source=fnr.web',
    city: 'New York',
    country: 'USA',
    lat: 40.7128,
    lng: -74.006,
  },
  {
    ...
    genre: 'Culture · Public',
    category: 'news',
    stream: 'https://st01.sslstream.dlf.de/dlf/01/128/mp3/stream.mp3?aggregator=web',
    city: 'Berlin',
    country: 'Germany',
    lat: 52.4803,
    lng: 13.3348,
  },
  {
    ...
    genre: 'News · Talk',
    category: 'news',
    stream: 'https://stream.europe1.fr/europe1.aac',
    city: 'Paris',
    country: 'France',
    lat: 48.8566,
    lng: 2.3522,
  },
  {
    ...
    category: 'news',
    stream: 'http://livex.radiopopolare.it/radiopop',
    city: 'Milan',
    country: 'Italy',
    lat: 45.4642,
    lng: 9.19,
  ...
  },
  {
    ...
    genre: 'Jazz · Heritage',
    category: 'music',
    stream: 'http://wwoz-sc.streamguys.com/wwoz-hi.mp3',
    city: 'New Orleans',
    country: 'USA',
    lat: 29.9511,
    lng: -90.0715,
  ...
  },
  {
    id: 'rp-mellow',
    name: 'RP Mellow Mix',
    genre: 'Eclectic · Mellow',
    category: 'music',
    stream: 'http://stream.radioparadise.com/mellow-320',
    city: 'Paradise',
    country: 'USA',
    lat: 40.785,
    lng: -124.184,
  },
  {
    ...
    genre: 'Eclectic · Rock',
    category: 'music',
    stream: 'http://stream.radioparadise.com/rock-320',
    city: 'Paradise',
    country: 'USA',
    lat: 40.785,
    lng: -124.184,
  },
  {
    ...
    category: 'music',
    stream: 'http://radio.stereoscenic.com/mod-h',
    city: 'Online',
    country: 'USA',
    lat: 37.7749,
    lng: -122.4194,
  ...
  },
  {
    ...
    category: 'music',
    stream: 'http://198.15.94.34:8006/stream',
    city: 'Philadelphia',
    country: 'USA',
    lat: 39.9526,
    lng: -75.1652,
  },
  {
    ...
    genre: 'Jazz · Blues',
    category: 'music',
    stream: 'http://jazzblues.ice.infomaniak.ch/jazzblues-high.mp3',
    city: 'Paris',
    country: 'France',
    lat: 48.8566,
    lng: 2.3522,
  },
  {
    ...
    category: 'music',
    stream: 'https://icecast.walmradio.com:8443/classic',
    city: 'New York',
    country: 'USA',
    lat: 40.7517,
    lng: -73.9754,
  ...
  {
    id: 'jazz-underground',
    name: 'Jazz Underground',
    genre: 'Jazz · Avant-garde',
    category: 'music',
    stream: 'https://icecast.walmradio.com:8443/jazz',
    city: 'New York',
    country: 'USA',
    lat: 40.7517,
    lng: -73.9754,
