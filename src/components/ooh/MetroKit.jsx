      ...
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-24">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <article className="flex flex-col gap-5 rounded-xl border border-border bg-primary p-6 text-primary-foreground shadow-sm">
            ...
            <Link to="/map" className="mt-auto inline-flex items-center gap-1.5 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-ozone transition-colors hover:text-flare">
          ...
          <article className="relative flex min-h-[260px] flex-col justify-between overflow-hidden rounded-xl border border-border p-6 shadow-sm">
            ...
            <Link
              to="/report"
              className="relative inline-flex w-fit items-center gap-1.5 rounded-full bg-white px-4 py-2.5 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-black transition-colors hover:bg-ozone"
            >
          ...
          <article className="flex flex-col gap-5 rounded-xl border border-border bg-primary p-6 text-primary-foreground shadow-sm">
            ...
            <div className="mt-auto flex items-center gap-2 font-mono text-[9px] uppercase tracking-[0.2em] text-primary-foreground/50">
              <MapPin className="h-3 w-3 text-ozone" /> Live telemetry · updates hourly
            </div>
          </article>
        </div>
      </div>
