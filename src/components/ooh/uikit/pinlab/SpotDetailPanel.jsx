    ...
    <div className="grid gap-3 md:grid-cols-2">
      ...
      <div className="border border-slate2/60 bg-card p-4">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <span className="bg-ozone px-2 py-0.5 font-mono text-[9px] font-bold uppercase tracking-[0.2em] text-void">
              Billboard
            </span>
            <span className="font-mono text-[9px] tabular text-dim">6 post count</span>
          </div>
          <span className="border border-slate2 px-2 py-0.5 font-mono text-[8px] uppercase tracking-[0.2em] text-darkgray">
            Build Hollywood
          </span>
        </div>

        <h3 className="mt-3 font-display text-2xl font-black uppercase tracking-tight text-silver">
          Run Duck Cover
        </h3>
        ...
        <a
          ...
          className="mt-2 inline-flex items-center gap-1 font-mono text-[9px] uppercase tracking-[0.2em] text-ozone"
        >
        ...
        <div className="mt-4 grid place-items-center border border-slate2 bg-void p-6">
          <span className="font-display text-lg font-black uppercase tracking-[0.2em] text-silver">
            48 Sheet Billboard
          </span>
          <span className="mt-1 font-mono text-[9px] uppercase tracking-[0.2em] text-dim">
            Artwork size: 1200 x 600mm
          </span>
        </div>
      ...
      <div className="border border-slate2/60 bg-card p-4">
        ...
        <p className="mt-2 font-display text-[12px] leading-relaxed text-darkgray">
          6mm hex key with a 4mm hole drilled in the bottom — opens most billboard poster-housing
          cam locks.
        </p>
        ...
        <div className="mt-4 border-l-2 border-[#008080] bg-[#008080]/10 p-3">
          <p className="font-display text-[12px] leading-relaxed text-[#5fe6e6]">
            <span className="font-bold">Graffiti writers —</span> how sick would your tag or
            throw-up look illuminated at night in one of these spaces… just sayin'.
          </p>
        </div>
        ...
        <p className="mt-3 font-mono text-[9px] uppercase leading-relaxed tracking-[0.08em] text-dim">
          // Some advertising spaces that need a key have shiny old locks. Don't lose your shit in a
          mad panic — move on to another and make sure it opens before you start your installation.
        </p>
      </div>
    </div>
  );
