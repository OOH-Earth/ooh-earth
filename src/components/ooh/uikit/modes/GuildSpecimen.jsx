...
export default function GuildSpecimen() {
  return (
    <div
      className="guild relative overflow-hidden"
      style={{ background: '#002554', minHeight: 320 }}
    >
      {/* Header */}
      <div
        className="flex items-center justify-between"
        style={{ padding: '12px 16px', borderBottom: '1px solid rgba(237,255,0,0.15)' }}
      >
        <span
          style={{
      ...
      <div style={{ padding: '24px 16px 20px' }}>
        ...
        >
          We are a <span style={{ color: '#EDFF00' }}>public service organisation</span> following
          the Brandalism manifesto &amp; Reithian traditions.
        </h3>
        <p
          style={{
            fontFamily: 'Inter Tight, sans-serif',
        ...
        >
          We are dedicated to the removal and detoxification of propaganda on the streets of our
          communities that encourages needless consumption and increases waste.
        </p>
      </div>
