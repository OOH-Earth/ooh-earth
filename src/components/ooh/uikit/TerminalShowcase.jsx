    ...
    <div className="space-y-4">
      ...
      <div className="overflow-hidden border border-ozone/20 bg-[#0a0b0d] crt-scanlines">
        ...
        <div className="flex items-center gap-1.5 border-b border-ozone/15 bg-[#080809] px-3 py-2">
          ...
          <span className="ml-2 font-mono text-[9px] uppercase tracking-[0.2em] text-dim/60">
            telemetry.ts
          </span>
          <span className="ml-auto font-mono text-[8px] uppercase tracking-[0.15em] text-dim/40">
            BETA · DEVTOOLS
          </span>
        </div>
        ...
        <div className="flex">
          ...
          <div className="flex-1 px-3 py-3 font-mono text-[10px] leading-[1.6]">
            <div>
              ...
              <span className="text-[#8be9fd]">spots</span> ={' '}
              <span className="text-[#50fa7b]">042</span>;
            </div>
            <div>
              <span className="text-[#bd93f9]">const</span>{' '}
              <span className="text-[#8be9fd]">resist</span> ={' '}
              <span className="text-[#50fa7b]">"visual commons"</span>;
            </div>
            <div className="text-[#6272a4]">{'// field sync active'}</div>
            <div>
              <span className="text-[#bd93f9]">log</span>(
              <span className="text-[#8be9fd]">spots</span> +{' '}
              <span className="text-[#50fa7b]">" reclaimed"</span>);
            </div>
      ...
      {/* === Button variants === */}
      <div>
        <div className="mb-2 font-mono text-[9px] uppercase tracking-[0.25em] text-dim/60">
          // action surfaces
        </div>
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
          {[
            ...
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.background = btn.filled ? `${btn.color}15` : 'transparent';
      ...
      <div>
        ...
        <div className="max-w-[240px] border border-ozone/15 bg-[#0a0a0a] crt-scanlines">
          ...
          <div className="flex items-center gap-1.5 border-b border-ozone/10 bg-[#080808] px-2.5 py-1.5">
            ...
            <span className="ml-1.5 font-mono text-[8px] uppercase tracking-[0.2em] text-dim/50">
              billboard.ts
            </span>
            <span className="ml-auto font-mono text-[6px] uppercase tracking-[0.15em] text-dim/30">
              DEV
            </span>
          </div>
          {/* Thumbnail placeholder */}
          <div className="relative flex h-[80px] items-center justify-center grid-bg bg-[#0a0a0a]">
            <span className="font-mono text-[7px] font-bold uppercase tracking-[0.2em] text-ozone/60">
              // photo
            </span>
          </div>
          {/* Content */}
          <div className="px-2.5 py-2">
            <div className="flex items-center gap-1.5">
              <span className="font-mono text-[8px] font-bold uppercase tracking-[0.2em] text-ozone">
                Billboard
              </span>
              <span className="h-1 w-1 rounded-full bg-[#39FF14]" />
              <span className="font-mono text-[8px] uppercase tracking-[0.15em] text-dim/50">
                verified
              </span>
            </div>
            <div className="mt-1 font-mono text-[11px] font-bold text-silver">
              Billboard · 1039 Phloenchit
            </div>
            <div className="mt-0.5 font-mono text-[8px] text-dim/50">13.7256, 100.5770</div>
            <div className="mt-2 flex gap-1.5">
              <span className="border border-flare/50 px-2 py-0.5 font-mono text-[7px] font-bold uppercase tracking-[0.15em] text-flare">
                Directions ↗
              </span>
              <span className="border border-ozone/50 px-2 py-0.5 font-mono text-[7px] font-bold uppercase tracking-[0.15em] text-ozone">
                Page ↗
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-4 gap-px border border-ozone/15 bg-slate2/30">
          {[
            ...
            <div key={s.k} className="bg-[#0a0a0a] px-2 py-2 text-center">
              <div className="font-mono text-[8px] uppercase tracking-[0.15em] text-dim/50">
                {s.k}
              </div>
              <div
