          ...
          >
            <div className="flex items-center justify-between border-b border-slate2/60 px-5 py-4">
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-mono text-[10px] font-bold uppercase tracking-[0.3em] text-silver">
                  Dashboard
                </span>
              </div>
              <button
            ...
            <div className="atlas-track flex-1 overflow-y-auto px-5 py-5">
              <div className="relative overflow-hidden border border-slate2/60 bg-card p-5">
                ...
                <div className="mt-3 font-mono text-4xl font-bold tabular tracking-tight text-silver text-glow-ozone">
                  {time}
                </div>
                <div className="mt-1 font-mono text-[10px] uppercase tracking-[0.25em] text-dim">
                  {date}
                </div>
              </div>
              ...
              <div className="mt-3 grid grid-cols-2 gap-2">
                {tiles.map((t) => (
                  <div key={t.k} className="border border-slate2/60 bg-card p-3">
                    ...
                    <div
                      className="mt-1.5 font-mono text-2xl font-bold tabular"
                      style={{ color: t.c }}
                    >
                      {t.v}
                    </div>
              ...
              <div className="mt-3 border border-slate2/60 bg-card p-4">
                ...
                <div className="mt-2 font-mono text-[9px] uppercase tracking-[0.25em] text-dim">
                  network online · sync live
                </div>
              </div>
