      ...
      <div className="px-5 py-16 md:px-8 md:py-24">
        <div className="flex flex-col gap-4 border-b border-slate2/40 pb-6 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-sm font-display text-sm font-normal leading-[1.4] text-darkgray">
            Klima DAO retires carbon credits permanently on-chain — every tonne is verifiably
            burned, not traded into existence. This is the counter the ad industry doesn't have:
            irreversible, public, mathematically certain.
          </p>
        </div>
          ...
          <div className="border border-slate2/60 bg-void p-8 md:p-12">
            ...
            {!data ? (
              ...
              <>
                ...
                <div className="mt-3 font-mono text-[10px] uppercase tracking-[0.2em] text-darkgray">
                  tCO₂e retired via Klima DAO
                </div>
                {data.source && (
