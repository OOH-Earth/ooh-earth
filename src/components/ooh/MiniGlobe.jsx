    ...
    >
      <span className="relative block">
        ...
        <svg viewBox="0 0 40 40" className="relative h-8 w-8">
          <circle cx="20" cy="20" r="12.5" fill="#080808" stroke="rgb(var(--c-ozone))" strokeOpacity="0.4" strokeWidth="0.8" />

          {/* rotating graticule + field dots */}
          <g>
            <ellipse cx="20" cy="20" rx="12.5" ry="4.5" fill="none" stroke="rgb(var(--c-silver))" strokeOpacity="0.28" strokeWidth="0.5" />
            <ellipse cx="20" cy="20" rx="12.5" ry="9" fill="none" stroke="rgb(var(--c-silver))" strokeOpacity="0.18" strokeWidth="0.4" />
            <ellipse cx="20" cy="20" rx="4.5" ry="12.5" fill="none" stroke="rgb(var(--c-silver))" strokeOpacity="0.28" strokeWidth="0.5" />
            <ellipse cx="20" cy="20" rx="9" ry="12.5" fill="none" stroke="rgb(var(--c-silver))" strokeOpacity="0.18" strokeWidth="0.4" />
            <line x1="20" y1="7.5" x2="20" y2="32.5" stroke="rgb(var(--c-silver))" strokeOpacity="0.3" strokeWidth="0.4" />
            <line x1="7.5" y1="20" x2="32.5" y2="20" stroke="rgb(var(--c-silver))" strokeOpacity="0.3" strokeWidth="0.4" />
          ...
          {/* orbit + satellite */}
          <g>
            <ellipse cx="20" cy="20" rx="17" ry="6.5" fill="none" stroke="rgb(var(--c-ozone))" strokeOpacity="0.55" strokeWidth="0.7" />
            <circle cx="37" cy="20" r="1.4" fill="rgb(var(--c-ozone))" style={{ filter: "drop-shadow(0 0 2.5px rgba(237,255,0,0.9))" }} />
