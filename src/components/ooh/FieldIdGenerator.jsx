...
const inputCls =
  'w-full border border-slate2 bg-card px-3 py-2 font-body text-sm text-silver outline-none focus:border-ozone';
  ...
  return (
    <section className="border-t border-slate2/40 px-5 py-14 md:px-8">
      <div className="mx-auto max-w-5xl">
        <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-ozone">
          // Tactical credential
        </span>
        ...
        <p className="mt-3 max-w-2xl font-body text-sm leading-[1.6] text-darkgray">
          Mint a printable member credential right here. Enter your details or load from the roster,
          preview the badge, and print or save as PDF — carry proof of membership in the field.
        </p>

        <div className="mt-8 grid gap-6 md:grid-cols-[1fr_auto]">
          <div className="no-print space-y-3 border border-slate2/60 bg-card p-5">
            <div className="mb-1 font-mono text-[9px] font-bold uppercase tracking-[0.3em] text-silver">
              Credential builder
            </div>
            ...
            <label className="flex items-center gap-2 pt-1">
              <input
                ...
                className="h-4 w-4 accent-[#EDFF00]"
              />
              <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-silver/70">
                Verified member
              </span>
            </label>
            <Link
              to="/field-id"
              className="mt-1 inline-block font-mono text-[9px] uppercase tracking-[0.25em] text-ozone transition-colors hover:text-flare"
            >
              Full credential kit →
            </Link>
          </div>
