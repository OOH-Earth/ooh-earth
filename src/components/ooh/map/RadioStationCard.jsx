  ...
  return (
    ...
    >
      <div className="min-w-0">
        ...
        <div
          className={`mt-0.5 truncate font-display text-[12px] font-medium tracking-[-0.01em] ${isActive ? 'text-ozone' : 'text-silver/80'}`}
        >
          {station.name}
        </div>
        <div className="font-mono text-[7px] uppercase tracking-[0.12em] text-dim/60">
          {station.genre}
        </div>
      </div>
