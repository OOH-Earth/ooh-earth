...
export default function CompactPinPopup({ m, onExpand }) {
  ...
  return (
    <div style={{
      ...
      background: "#0a0a0a",
      backgroundImage: "linear-gradient(rgba(237,255,0,0.025) 1px, transparent 1px), linear-gradient(90deg, rgba(237,255,0,0.025) 1px, transparent 1px)",
      ...
      <div style={{
        ...
        <span style={{ marginLeft: 6, fontSize: 7, textTransform: "uppercase", letterSpacing: "0.2em", color: "#555", fontWeight: 700 }}>
      ...
      <div style={{ padding: "8px 10px", position: "relative" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
          <span style={{ fontSize: 8, textTransform: "uppercase", letterSpacing: "0.15em", fontWeight: 700, color: accent }}>
            {metaFor(m.type).label}
          </span>
          <span style={{ width: 4, height: 4, borderRadius: "50%", background: dotColor }} />
          <span style={{ fontSize: 7, textTransform: "uppercase", letterSpacing: "0.15em", color: "#555" }}>{m.status}</span>
        </div>
        ...
        {/* Coordinates */}
        <div style={{ fontSize: 8, color: "#333", marginTop: 2, fontFamily: "'IBM Plex Mono', monospace" }}>
