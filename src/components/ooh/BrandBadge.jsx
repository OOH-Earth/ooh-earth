...
function GoldenArches() {
  return (
    <svg viewBox="0 0 24 24" className="h-[60%] w-[60%]">
      <path d="M8 3 C6.5 3 5.5 5 5.5 8 L5.5 14 C5.5 16 5 17 4 17 C5.5 17 6.5 15 6.5 12 L6.5 8 C6.5 6 7 5 8 5 Z" fill="#FFC72C"/>
      <path d="M16 3 C17.5 3 18.5 5 18.5 8 L18.5 14 C18.5 16 19 17 20 17 C18.5 17 17.5 15 17.5 12 L17.5 8 C17.5 6 17 5 16 5 Z" fill="#FFC72C"/>
    </svg>
  );
}
...
function ShellLogo() {
  return (
    <svg viewBox="0 0 24 24" className="h-[55%] w-[55%]">
      <path d="M12 3 L19 7 L17 17 L12 21 L7 17 L5 7 Z" fill="#FBCE07" stroke="#DD1D21" strokeWidth="1.5"/>
...
function AppleGlyph() {
  return (
    <svg viewBox="0 0 24 24" className="h-[55%] w-[55%]">
      <path d="M18 14 C18 18 15 20 12 20 C9 20 6 18 6 14 C6 12 7 10 8 9 C9 10 10 11 12 11 C14 11 15 10 16 9 C17 10 18 12 18 14 Z M12 4 C12 6 11 7 9 7 C9 5 10 4 12 4 Z" fill="#FFFFFF"/>
    </svg>
  );
}
...
function MetaInfinity() {
  return (
    <svg viewBox="0 0 24 24" className="h-[50%] w-[60%]">
      <path d="M4 12 C4 8 6 6 8 8 C10 10 10 14 12 16 C14 18 16 18 18 16 C20 14 20 10 18 8 C16 6 14 6 12 8 C10 10 10 14 8 16 C6 18 4 16 4 12 Z" fill="none" stroke="#FFFFFF" strokeWidth="2"/>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 24 24" className="h-[55%] w-[55%]">
      {colors.slice(0, 6).map((c, i) => (
        <rect key={i} x={2 + (i % 3) * 7} y={2 + Math.floor(i / 3) * 7} width="6" height="6" fill={c} />
      ))}
    </svg>
  );
}
...
export function BrandIcon({ name, size = 20, className = "" }) {
  ...
  return (
    ...
    >
      {brand.svg || (
        <span className="font-mono text-[8px] font-bold leading-none">{brand.label || name.slice(0, 2).toUpperCase()}</span>
      )}
    </span>
  );
}
...
export function BrandBadge({ name, className = "" }) {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 border border-slate2/50 bg-card px-2 py-1 ${className}`}>
      <BrandIcon name={name} size={16} />
      <span className="font-mono text-[9px] font-bold uppercase tracking-[0.1em] text-silver">{name}</span>
    </span>
  );
}
