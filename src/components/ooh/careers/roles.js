...
export const ROLES = [
  // ─────────── Field & Community ───────────
  {
    ...
    summary:
      'Document advertising and subvertising in the wild — photos, GPS and access-key intel, filed from the street.',
    tags: ['Reporting', 'Photography', 'Field ID'],
    about:
      'The eyes of the atlas. Members walk their own streets and turn corporate advertising into open, mapped, contestable data — logging billboards, bus-stop screens and illegal hoardings so the whole network can see and act on them.',
    responsibilities: [
  ...
  },
  {
    ...
    summary:
      'Be the face of the movement in your city — welcome new members, run meet-ups and local subvertising campaigns.',
    tags: ['Organising', 'Community', 'Local'],
    about:
      'Ambassadors turn a scatter of members into a local crew. You represent OOH Earth in your city, grow the network, and lead the actions that make the atlas matter on the ground.',
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Volunteer',
    summary:
      'Verify and curate incoming reports, tag brands and access keys, and keep the atlas accurate and organised.',
    tags: ['Curation', 'Verification', 'Tagging'],
    about:
      'The atlas is only as good as its data. Curators are the quality layer — reviewing incoming reports, confirming details, tagging brands and offense types, and keeping everything clean and trustworthy.',
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Volunteer',
    summary:
      'Open the atlas to the world — translate the platform and field guides, with a focus on Global-South languages.',
    tags: ['Translation', 'Localisation', 'Access'],
    about:
      'Resistance to advertising is global, and led from the Global South — but tools built only in English lock most of the world out. Translators make the platform, field guides and campaigns speak in more languages.',
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Volunteer',
    summary:
      'Map the rules — advertising law, planning consent and public-space rights — so members act informed and safe.',
    tags: ['Law', 'Policy', 'Rights'],
    about:
      'Knowing the law is power. Observers research how outdoor advertising is regulated where you are, document illegal installs, and help members understand their rights before they act.',
    responsibilities: [
  ...
  },
  {
    ...
    summary:
      'Lead the member network in your region — triage reports, verify spots, onboard members and run campaigns.',
    tags: ['Operations', 'Community', 'Logistics'],
    about:
      'Coordinators keep a whole region moving — the connective tissue between members and the core team. You run the day-to-day of the network where you are.',
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Part-time — paid where funded, honorarium otherwise',
    summary:
      'Run the member community across channels — onboard, motivate, surface wins, keep the network coordinated and safe.',
    tags: ['Community', 'Social', 'Onboarding'],
    about:
      'You hold the community together — the voice that welcomes new members, celebrates the wins, defuses the friction and keeps thousands of people pulling the same way, safely.',
    responsibilities: [
  ...
  // ─────────── Build & Design ───────────
  {
    ...
    about:
      "The field tools have to work on a cheap phone, in the street, offline, at night. You'll build the interfaces members actually rely on — fast, legible and resilient.",
    responsibilities: [
  ...
  },
  {
    ...
    about:
      'You keep the atlas standing. From data entities to payment and treasury tooling to the pipelines that feed the live map, you own the plumbing the whole platform runs on.',
    responsibilities: [
  ...
  },
  {
    ...
    about:
      'The look matters too. You steward the Orbital Perspective identity and design interfaces that stay legible and unmistakable in the hardest conditions members face.',
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Volunteer',
    summary:
      'Investigate who owns the ad space — operators, networks and the money behind the boards — and open it up as data.',
    tags: ['Research', 'OSINT', 'Data'],
    about:
      'Behind every billboard is an owner, an operator and a client. Researchers follow that trail — mapping the companies and money behind outdoor advertising and turning it into open, structured data.',
    responsibilities: [
  ...
  // experience without a client on the other end of it.
  {
    ...
    summary:
      'Rotate onto campaign creative a few hours a month — the senior eye without the day job.',
    tags: ['Creative', 'Campaigns', 'Advisory'],
    about:
      "For creative directors and senior creatives who've spent a career on the client side of outdoor advertising and want a genuine seat on the other side of it — reviewing campaign creative, sense-checking tone, and lending craft to work that's never going to a client for approval.",
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Advisory seat — unpaid, expenses covered for any in-person reviews',
    summary:
      'Bring agency-side media and planning knowledge to bear on where the real pressure points in OOH buying and permitting sit.',
    tags: ['Media', 'Planning', 'Advisory'],
    about:
      "Nobody understands how outdoor advertising actually gets bought, planned and permitted better than people who've spent a career doing it for agencies and media owners. This is a seat for that knowledge — pointed at accountability instead of sales.",
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Advisory seat — unpaid, expenses covered for any in-person reviews',
    summary:
      'Senior legal counsel on advertising standards, planning law and public-space rights — the seat that keeps the movement lawful and confident.',
    tags: ['Law', 'Advertising Standards', 'Advisory'],
    about:
      "Distinct from our volunteer Legal & Rights Observers doing ground-level research — this is a senior advisory seat for a lawyer who can sanity-check the platform's public claims, campaign framing and objection tools before they go out.",
    responsibilities: [
  ...
  // ─────────── Growth & Funding ───────────
  {
    ...
    summary:
      'Help the movement fund itself without ad money — find grants, draft applications, keep the pipeline moving.',
    tags: ['Grants', 'Funding', 'Research'],
    about:
      'Everything here is free because the community funds it — no ad money. You help keep it that way: hunting down grants and fellowships, drafting applications, and keeping our funding pipeline organised and moving.',
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Volunteer',
    summary:
      'Grow community funding — run campaigns, steward supporters, and rally small donors behind the resistance.',
    tags: ['Fundraising', 'Campaigns', 'Donors'],
    about:
      'Community funding is the whole point — every pound comes from people, not advertisers. You help grow it: running fundraising campaigns, welcoming supporters, and turning a movement into a membership.',
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Part-time — paid where funded, honorarium otherwise',
    summary:
      'Turn agency relationships into real backing — in-kind support, funding and campaign amplification — pitched on what the movement is actually worth.',
    tags: ['Partnerships', 'Agency Backing', 'Fundraising'],
    about:
      'The movement is bigger than us, and so is the ask. You build alliances with NGOs, adbusting collectives, academics and — critically — agencies and ethical funders willing to back a project like this, using a plain replacement-cost-plus-traction pitch instead of a startup multiple nobody asked for.',
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Part-time — paid where funded, honorarium otherwise',
    summary:
      'Own the funding operations layer — campaign consolidation, payment plumbing, and the pipeline that keeps a community-funded platform solvent.',
    tags: ['Fundraising', 'Operations', 'Leadership'],
    about:
      "Above the volunteer fundraising and grants roles sits the person who owns the whole funding operation — consolidating campaigns, keeping payment processing straight, and building a pipeline that doesn't depend on one founder holding it all in their head.",
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Part-time — paid where funded, honorarium otherwise',
    summary:
      'Own the automation layer — workflows, integrations and the plumbing that keeps the platform running without it all sitting on one person.',
    tags: ['Operations', 'Automation', 'Leadership'],
    about:
      "A platform this ambitious can't run on founder-memory forever. You own the automation and integration layer — the workflows connecting donations, community tools and the live platform — so growth doesn't mean everything breaks.",
    responsibilities: [
  ...
  },
  {
    ...
    comp: 'Volunteer',
    summary:
      'Turn field wins into content that travels — posts, threads and short video that grow the network and the funding.',
    tags: ['Social', 'Content', 'Storytelling'],
    about:
      'The best subvertising deserves an audience. You turn member wins, maps and milestones into content that spreads the movement and pulls new people and funding in.',
    responsibilities: [
...
ROLES.forEach((r) => {
  r.status = ROLE_STATUS[r.id] || 'future';
});

export const STATUS_META = {
  live: {
    label: 'Live role',
    cls: 'border-[#39FF14]/50 text-[#39FF14]',
    dot: 'bg-[#39FF14]',
    cta: 'Apply',
  },
  future: {
...
export const LOOK_FOR = [
  {
    title: "You'd rather do than debate",
    body: "You'd rather map the billboard than argue about it. The people who flourish here move first — file the report, run the action, ship the fix, then talk about it.",
  },
  {
    title: 'You work like an open book',
    body: "Our data, code and methods are public and forkable. You're at ease in the open — sharing the credit, leaving the receipts, building things anyone can inspect and borrow.",
  },
  {
    title: "You'd rather be right than loud",
    body: 'The atlas lives or dies on accuracy. You cite your sources, check before you claim, and never let a good story outrun the facts.',
  },
  {
    title: "You're in it for the right reasons",
    body: "Community-funded, no ad money. The reward isn't a windfall — it's public space reclaimed and a movement that outgrows you.",
  },
  {
    title: 'You look out for everyone',
    body: 'We centre the Global South, the overlooked, the advertised-at. You bring real care for people into the work — not just polish for the product.',
  },
];
...
export const SUPPORT = [
  {
    title: 'Field costs, not out of pocket',
    body: 'Where the community treasury allows, we reimburse reasonable field costs — transport, printing, access tools — so volunteering never costs you money to do.',
  },
  {
    title: 'Micro-grants for local action',
    body: 'Small grants for members and ambassadors running local campaigns, subvertising actions or city meet-ups. Apply through your coordinator.',
  },
  {
    title: 'Real credentials & references',
    body: 'Member credentials, a public record of your contributions, and honest references for jobs, grants or study.',
  },
  {
    title: 'Skills, not just labour',
    body: 'Hands-on mentoring in mapping, investigation, organising and open-source tools — you leave sharper than you arrived.',
  },
];
...
export const VALUES = [
  {
    ...
    body: 'We map what brands pay to hide in plain sight. Visibility is the point.',
  },
  {
    icon: 'HandHeart',
    title: 'Community-funded',
    body: 'No ad money. The treasury and the work answer to members.',
  },
  {
    icon: 'Zap',
    title: 'Field-ready',
...
export const PROCESS = [
  {
    step: '01',
    title: 'Apply',
    body: "Send a short note — who you are, what you'd build, and a link or two.",
  },
  {
    step: '02',
    title: 'Talk',
    body: 'A 30-minute call with the core team. No take-homes, no whiteboards.',
  },
  {
    step: '03',
    title: 'Field test',
    body: 'A paid micro-task or a trial shift on a real piece of the atlas.',
  },
