...
export const CAPITAL_LEADS = {
  'impact-grants': {
    ...
    unlocks: [
      {
        h: 'Evidence at scale',
        p: 'Fund the map import + verification pipeline to move from ~12k beta records to a diligence-grade dataset.',
      },
      {
        h: 'Community toolkits',
        p: 'Objection generator, field guides, and chapter kits so residents can act on the evidence.',
      },
      {
        h: 'Precedent & policy',
        p: 'Turn documented cases into council submissions and policy briefs with citable outcomes.',
      },
    ],
    targets:
      'Civic & urban-space foundations · SDG 11.7 / 16.7 programmes · cultural-rights and public-realm grantmakers',
  },
  philanthropic: {
    slug: 'philanthropic',
    ...
    unlocks: [
      {
        h: 'Activate the waitlist',
        p: 'Convert ~2,000 waiting supporters into active members with onboarding and field kits.',
      },
      {
        h: 'Global South chapters',
        p: 'Stand up city chapters where public-space enclosure hits hardest — per the SDGs.',
      },
      {
        h: 'Founder runway',
        p: 'Modest runway to run live ops full-time through launch and the first campaigns.',
      },
    ],
  ...
  'retro-pgf': {
    ...
    unlocks: [
      {
        h: 'Harden the on-chain rails',
        p: 'Finish evidence minting + treasury routing so contributions are transparent and auditable.',
      },
      {
        h: 'Open the dataset',
        p: 'Publish the documented-sites dataset as reusable public infrastructure.',
      },
      {
        h: 'Reward contributors',
        p: 'Route retro funding to the ambassadors and members who built the evidence base.',
      },
    ],
  ...
  'civic-tech': {
    ...
    unlocks: [
      {
        h: 'Ship to production',
        p: 'Fund the hardening sweep + HTTPS deploy that unblocks camera capture and NFC.',
      },
      {
        h: 'Scale live ops',
        p: 'Automation spine (n8n) and chapter tooling to run distributed operations.',
      },
      {
        h: 'Case study & co-marketing',
        p: 'A documented build story platforms can feature — value flows both ways.',
      },
    ],
    targets:
      'Civic-tech accelerators · gov-tech / open-data funds · platform-sponsorship programmes',
  },
};
