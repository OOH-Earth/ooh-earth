...
const SOUTH = [
  ...
  { city: 'Bangkok', country: 'Thailand', logged: 10, level: 40 },
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="mt-1 flex items-end justify-between">
          <h3 className="font-display text-2xl font-black uppercase tracking-tight text-silver">
            {c.city}
          </h3>
        ...
        <div className="mt-3 flex items-center gap-2">
          ...
          <span className="font-mono text-[9px] tabular-nums text-darkgray">{c.logged} logged</span>
        </div>
      </div>
    </Link>
  );
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-sm font-display text-sm leading-[1.5] text-darkgray">
            Ready-to-fill city grids across the Global North and South. Where corporate advertising
            goes unrecorded, the public record stays blind — every city below is awaiting field
            reports.
          </p>
        </div>
        ...
        <div className="mt-12 border border-slate2 bg-card p-5 md:p-6">
          <p className="font-display text-sm leading-[1.5] text-darkgray">
            ...
            record. Log a report from any city to flip it from{' '}
            <span className="text-flare">Standby</span> to <span className="text-ozone">Live</span>.
          </p>
        </div>
      </div>
    </section>
