...
export const REGIONS = [
  ...
  },
  {
    ...
    status: 'planned',
    access: 'open',
    note: 'Déboulonneurs / Brandalism heritage. Open EU data; queued.',
  },
  {
    slug: 'berlin',
    city: 'Berlin',
  ...
  },
  {
    ...
    status: 'planned',
    access: 'field',
    note: 'Field-only, like Bangkok — no open register to lean on.',
  },
  {
    slug: 'vancouver',
    city: 'Vancouver',
    ...
    status: 'planned',
    access: 'partial',
    note: "Adbusters' base. Mixed open data; queued.",
  },
];
...
export function regionOf(address = '') {
  ...
  for (const r of REGIONS)
    if (r.countryDefault && a.includes(r.country.toLowerCase())) return r.slug;
  return null;
}
