...
import {
  ...
  Trash2, Coins, CreditCard, Key, LayoutGrid, Info, Briefcase, Mail,
  BookOpen, Heart, Layers, LifeBuoy, Network, ShoppingBag,
  Ban, Leaf, Droplets, AlertTriangle, SprayCan,
...
const ICON = {
  ...
  Adbusting: Ban, Graffiti: SprayCan, Ecology: Leaf, Rivers: Droplets, "War Zones": AlertTriangle, "AFC Correspondents": Users,
