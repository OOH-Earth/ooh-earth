import {
  FileText, Eye, MapPin, Crosshair, ShieldCheck, Camera, Zap, Coins,
  Target, Flame, Rocket, Award, Lock,
} from "lucide-react";
import { BADGES, TIER_STYLES } from "@/components/ooh/gamification/gamification";

const ICONS = {
  FileText, Eye, MapPin, Crosshair, ShieldCheck, Camera, Zap, Coins,
  Target, Flame, Rocket, Award,
};
...
function Badge({ badge, earned }) {
  ...
  return (
    ...
    >
      ...
      <div className="font-mono text-[8px] font-bold uppercase tracking-[0.15em] text-silver">{badge.label}</div>
  ...
  return (
    <div>
      <div className="mb-3 flex items-center justify-between">
        <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-ozone">// Merit Badges</span>
        <span className="font-mono text-[9px] tabular text-dim">{earnedCount} / {BADGES.length} earned</span>
      </div>
      {badges.length === 0 ? (
