      ...
      {brandCounts.length === 0 ? (
        ...
        <div className="flex flex-wrap gap-2">
          {brandCounts.map(({ brand, count }) => (
            ...
            >
              <span className="font-mono text-[0.6875rem] uppercase tracking-[0.1em] text-silver">
                {brand}
              </span>
              <span className="font-mono text-[0.6875rem] font-bold tabular text-ozone">
                ×{count}
              </span>
            </div>
          ))}
