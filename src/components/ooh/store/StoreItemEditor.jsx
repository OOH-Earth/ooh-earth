      ...
      <DialogContent className="max-h-[88vh] overflow-y-auto max-w-2xl bg-card border-slate2 text-silver">
        ...
        <div className="grid gap-4 py-2">
          <Field label="Title *">
            <Input
              ...
              className="bg-void border-slate2"
            />
          </Field>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="Category">
              <Select value={form.category} onValueChange={(v) => set('category', v)}>
                <SelectTrigger className="bg-void border-slate2">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {CATEGORIES.map((c) => (
          ...
          <Field label="Image URL">
            <Input
              ...
              className="bg-void border-slate2 font-mono text-[10px]"
              placeholder="https://…"
            />
          </Field>
          ...
          <Field label="Tags (comma-separated)">
            <Input
              ...
              className="bg-void border-slate2"
              placeholder="research, bristol, billboard"
            />
          </Field>
        ...
        <DialogFooter className="gap-2">
          <Button
            variant="outline"
            onClick={onClose}
            className="border-slate2 bg-transparent text-silver hover:bg-slate2/30"
          >
            Cancel
          </Button>
          <Button
            ...
            className="bg-ozone text-void hover:bg-flare hover:text-void"
          >
            {busy ? (
...
function Field({ label, children }) {
  return (
    <div className="space-y-1.5">
      <Label className="font-mono text-[9px] uppercase tracking-[0.2em] text-silver/50">
        {label}
      </Label>
      {children}
    </div>
