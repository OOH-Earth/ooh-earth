  ...
  return (
    <div className="group flex flex-col border border-slate2/50 bg-card transition-colors hover:border-ozone/40">
      <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden border-b border-slate2/50 bg-void">
        ...
        <span className="absolute left-2 top-2 border border-slate2/60 bg-void/80 px-1.5 py-0.5 font-mono text-[8px] uppercase tracking-[0.2em] text-ozone backdrop-blur">
          Component
        </span>
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <p className="mt-2 flex-1 font-display text-[12px] leading-relaxed text-darkgray">
          {entry.desc}
        </p>
        <div className="mt-2 flex flex-wrap gap-1">
          {entry.tags.map((t) => (
            <span
              key={t}
              className="border border-slate2/50 px-1.5 py-0.5 font-mono text-[8px] uppercase tracking-[0.15em] text-dim"
            >
              {t}
            </span>
          ))}
        ...
        <div className="mt-4 flex items-center gap-2">
          <span className="flex-1 font-display text-lg font-black tabular text-silver">
            {entry.price}
          </span>
          <button
