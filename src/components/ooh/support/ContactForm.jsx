...
export default function ContactForm() {
  ...
  const field =
    'w-full border border-slate2 bg-void px-3 py-2.5 font-mono text-sm text-silver outline-none transition-colors placeholder:text-dim focus:border-ozone';
  ...
  if (sent) {
    return (
      <div className="border border-ozone/40 bg-ozone/5 p-6">
        ...
        <p className="mt-3 font-mono text-[11px] uppercase tracking-[0.2em] text-silver">
