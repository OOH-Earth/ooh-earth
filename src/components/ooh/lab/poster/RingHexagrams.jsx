...
const RINGS = "https://media.base44.com/images/public/6a62213cff3ccbca88c04ff5/c2b787a6d_Screenshot2026-08-01at202135.png";
  ...
  return (
    <section className="border border-slate2 bg-card p-6">
      ...
      <div className="mt-4 border border-slate2 bg-void">
        <Image src={RINGS} alt="Six rotating rings forming binary 101100 = Hexagram 44" fittingType="fit" className="block w-full h-[180px] sm:h-[240px] md:h-[300px]" />
      </div>
