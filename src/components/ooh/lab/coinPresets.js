...
export const COIN_EDITIONS = [
  {
    ...
    desc: 'First 1,000 · numbered 0001–1000',
    rarity: '1,000 minted',
    tier: 'primary',
  },
  {
    id: 'CITY EDITION',
    name: 'City Edition',
    desc: 'One per UNESCO Creative City',
    rarity: '640 minted',
    tier: 'secondary',
  },
  {
    id: 'ARTIST PROOF',
    name: 'Artist Proof',
    desc: 'Pre-production strikings, marked AP',
    rarity: '64 minted',
    tier: 'rare',
  },
];
...
export const SDG_ALIGNMENTS = [
  {
    ...
    desc: 'Reverse face engraves the city as network — infrastructure over borders.',
  },
  {
    num: 16,
    name: 'Peace & Justice',
    desc: 'Proof-of-presence for members documenting public-space offenses.',
  },
  {
    num: 17,
    name: 'Partnerships',
    desc: '1:1 on-chain twin binds physical artifact to a wallet-native DAO.',
  },
];
