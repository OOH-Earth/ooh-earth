  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="font-mono text-[11px] font-bold uppercase tracking-[0.15em] text-silver">
      ...
      <div className="mt-3 flex items-end justify-between">
        <span className="font-mono text-base font-bold text-silver">
          {d ? fmtPrice(d.price) : '…'}
        </span>
        {d?.change != null && (
          <span
            className={`flex items-center gap-0.5 font-mono text-[10px] ${up ? 'text-ozone' : 'text-flare'}`}
          >
