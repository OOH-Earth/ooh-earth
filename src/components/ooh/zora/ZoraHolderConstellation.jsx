    ...
    <div className="border border-slate2/60 bg-card p-5 md:p-7">
      <div className="mb-3 flex items-center justify-between">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-ozone">
          // market-pressure constellation
        </span>
        <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-dim">
          24h · {PRIMARY_COIN.symbol}
        </span>
      </div>
      <svg viewBox={`0 0 ${W} ${H}`} className="w-full" style={{ maxHeight: 260 }}>
        ...
        <text
          ...
          y={H - 8}
          textAnchor="middle"
          className="fill-ozone font-mono"
          fontSize="9"
        >
          {buys} buys
        </text>
        <text
          ...
          y={H - 8}
          textAnchor="middle"
          className="fill-flare font-mono"
          fontSize="9"
        >
          {sells} sells
        </text>
      ...
      <p className="mt-2 font-mono text-[9px] uppercase tracking-[0.2em] text-dim">
        node count ∝ trade volume · hub = {PRIMARY_COIN.symbol} · each node ≈ 8 txns
      </p>
    </div>
  );
}
