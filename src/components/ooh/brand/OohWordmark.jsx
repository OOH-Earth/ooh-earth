  ...
  return (
    <span className={`inline-flex items-center gap-3 ${className}`}>
      ...
      <span className="leading-none" style={{ fontFamily: "'Orbitron','Inter Tight',sans-serif" }}>
        <span className="block font-black tracking-tight text-ozone" style={{ fontSize: size * 0.9 }}>
          OOH<span className="text-flare">.</span>
        </span>
        <span className="block font-medium text-foreground/90" style={{ fontSize: size * 0.34, letterSpacing: "0.34em" }}>
          EARTH
        </span>
      </span>
    </span>
