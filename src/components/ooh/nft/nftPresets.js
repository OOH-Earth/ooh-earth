...
export const PREMADE_DESIGNS = [
  { id: "cleancity", title: "Clean City",       grade: "10",  labelColor: "ozone",  desc: "São Paulo-inspired ad-free metropolis" },
  { id: "reclaim",   title: "Reclaim",          grade: "9.5", labelColor: "flare",  desc: "Public-space reclamation directive" },
  { id: "greenwash", title: "Greenwash",        grade: "9",   labelColor: "alert",  desc: "Anti-greenwashing intervention" },
  { id: "subvert",   title: "Subvert",          grade: "9.5", labelColor: "signal", desc: "Culture-jamming protocol" },
  { id: "respond",   title: "Right to Respond", grade: "10",  labelColor: "mint",   desc: "Free expression in public space" },
  { id: "commons",   title: "Visual Commons",   grade: "9",   labelColor: "stealth",desc: "Open access · shared surface" },
];
