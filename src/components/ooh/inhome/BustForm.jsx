    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-lg border-slate2 bg-void p-0">
        <DialogHeader className="border-b border-slate2/60 px-5 py-4">
          <DialogTitle className="font-display text-lg font-bold text-silver">
            Log a digital bust
          </DialogTitle>
          <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-dim">
            // in-home adbusting · screen surface
          </p>
        </DialogHeader>
        <form onSubmit={submit} className="space-y-3 px-5 py-4">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="Roblox, Chrome, Instagram…"
                className="border-slate2 bg-void font-mono text-sm"
              />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => set('target_brand', e.target.value)}
                placeholder="Shell, Coca-Cola…"
                className="border-slate2 bg-void font-mono text-sm"
              />
            </div>
            <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="in-game billboard, banner ad, sponsored post…"
              className="border-slate2 bg-void font-mono text-sm"
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Brookhaven Sector 4, theguardian.com…"
              className="border-slate2 bg-void font-mono text-sm"
            />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="flex justify-end gap-2 pt-1">
            <Button
              ...
              variant="ghost"
              onClick={onClose}
              className="font-mono text-[10px] uppercase tracking-[0.2em] text-darkgray"
            >
              Cancel
            </Button>
            <Button
              type="submit"
              disabled={loading}
              className="bg-ozone font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-void hover:bg-flare"
            >
