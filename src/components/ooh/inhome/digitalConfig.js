...
export const SEED_BUSTS = [
  {
    ...
    surface: 'in-game billboard',
    target_brand: 'Shell',
    method: 'replace',
    region: 'Brookhaven · Sector 4',
    proof_url: '',
    notes: 'Replaced fossil-fuel promo with #TrueCost counter-ad',
  },
  {
    platform: 'browser',
    platform_name: 'Chrome',
    surface: 'banner takeover',
    target_brand: 'Coca-Cola',
    method: 'overlay',
    region: 'theguardian.com',
    proof_url: '',
  },
  {
    platform: 'social_feed',
    platform_name: 'Instagram',
    surface: 'sponsored post',
    target_brand: 'Nestlé',
    method: 'counter',
    region: 'Reels feed',
    proof_url: '',
  ...
  {
    platform: 'ar_layer',
    platform_name: 'TikTok AR',
    surface: 'branded lens',
  ...
  },
  {
    ...
    surface: 'pre-roll',
    target_brand: 'Unilever',
    method: 'overlay',
    region: 'Doomscroll channel',
    proof_url: '',
  },
  {
    platform: 'metaverse_game',
    platform_name: 'Decentraland',
    surface: 'plot billboard',
    target_brand: 'Adidas',
    method: 'replace',
    region: '(-34,12)',
    proof_url: '',
