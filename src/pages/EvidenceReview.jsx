...
const INPUTS = [
  ...
  'a defined place or corridor',
  'the advertising category',
  'a time boundary or source preference',
];
...
export default function EvidenceReview() {
  useSeo({
    ...
    image:
      'https://media.base44.com/images/public/6a62213cff3ccbca88c04ff5/ba44da8c8_generated_image.png',
  });
          ...
          <div className="px-5 py-16 md:px-8 md:py-24">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="mt-3 max-w-3xl font-display text-4xl font-bold leading-[1.04] tracking-[-0.02em] text-silver md:text-6xl">
                Turn a public-space question into a traceable evidence brief.
              </h1>
              <p className="mt-6 max-w-2xl font-display text-base leading-[1.6] text-darkgray md:text-lg">
                OOH Earth can organize publicly available evidence for a defined outdoor-advertising
                or public-space question. You receive sources, method, observations, and uncertainty
        ...
        <section className="border-b border-slate2/40 bg-card">
          <div className="mx-auto grid max-w-4xl gap-10 px-5 py-12 md:grid-cols-2 md:px-8 md:py-16">
            <div>
              ...
              <p className="mt-4 font-display text-sm leading-[1.6] text-darkgray">
                The review is scoped to a question, geography, category, and time boundary. It is
                evidence organization and analysis—not a legal opinion, complete inventory,
                ownership determination, or enforcement decision.
              </p>
              <ul className="mt-6 space-y-3">
                {[
                  ...
                  'reproducible links and handover',
                ].map((item) => (
                  <li
                    key={item}
                    className="flex items-start gap-3 font-display text-sm text-silver"
                  >
                    <Check className="mt-0.5 h-4 w-4 shrink-0 text-ozone" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="border border-slate2/50 bg-void p-6">
              ...
              <ul className="mt-4 space-y-3">
                {INPUTS.map((item) => (
                  <li key={item} className="font-display text-sm leading-[1.5] text-darkgray">
                    · {item}
                  </li>
                ))}
              </ul>
              <a
                ...
                className="mt-6 inline-flex items-center gap-2 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-ozone hover:text-flare"
              >
                <Mail className="h-3.5 w-3.5" /> hello@ooh.earth
              </a>
            </div>
          </div>
        </section>
