  ...
  return (
    <AuthShell>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link
              to="/forgot-password"
              className="font-mono text-[9px] uppercase tracking-wide text-dim transition-colors hover:text-ozone"
            >
              Forgot?
            </Link>
          </div>
      ...
      <div className="mt-6 border-t border-slate2/60 pt-5 text-center font-mono text-[11px] text-dim">
        New to the network?{' '}
        <Link to="/register" className="text-ozone hover:underline">
          Create an account →
        </Link>
      </div>
      <div className="mt-3 text-center">
        <Link
          to="/map"
          className="font-mono text-[10px] uppercase tracking-[0.15em] text-darkgray transition-colors hover:text-silver"
        >
