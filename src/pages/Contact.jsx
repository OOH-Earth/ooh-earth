...
const SOCIALS = [
  { label: "Instagram", handle: "@oohstreetmaps", href: "https://www.instagram.com/oohstreetmaps/", Icon: Instagram },
      ...
      <main className="page-top">
          ...
          <div className="px-5 py-16 md:px-8 md:py-24">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mt-5 max-w-xl font-display text-sm font-normal leading-[1.5] text-darkgray md:text-base">
                Reach out to join, collaborate, report a billboard, or support the work. We read every message — union-made, community-funded.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="border-b border-slate2/40 bg-card">
          <div className="px-5 py-12 md:px-8 md:py-16">
            <div className="mx-auto max-w-3xl">
              <h2 className="font-display text-2xl font-bold tracking-[-0.01em] text-silver md:text-3xl">Direct channels</h2>
              <div className="mt-6 grid gap-px border border-slate2/40 bg-slate2/40 sm:grid-cols-3">
                {SOCIALS.map(({ label, handle, href, Icon }) => (
                  ...
                  >
                    ...
                    <span className="font-display text-sm font-bold uppercase tracking-wide text-silver">{label}</span>
                    <span className="font-mono text-[10px] tracking-[0.1em] text-darkgray">{handle}</span>
                  </a>
                ))}
              </div>
              ...
              <div className="mt-8 space-y-4">
                ...
                >
                  ...
                  <span className="font-display text-sm font-bold text-silver">hello@ooh.earth</span>
                ...
                >
                  ...
                  <span className="font-display text-sm font-bold text-silver">Send a support message</span>
                ...
                >
                  ...
                  <span className="font-display text-sm font-bold text-silver">Report a billboard or adbust</span>
                  <ArrowUpRight className="ml-auto h-4 w-4 text-silver/40" />
                </Link>
              </div>
            </div>
