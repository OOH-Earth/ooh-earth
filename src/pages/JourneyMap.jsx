      ...
      <main className="page-top px-5 pb-24 md:px-8">
        <div className="jm-root mx-auto max-w-[1240px]">
          ...
          <header className="jm-head">
            ...
            <h1 className="jm-title">UX JOURNEY MAP <span className="dot">/</span> OOH EARTH</h1>
            <p className="jm-sub">The full path through the civic platform — mapped from every side of the screen, wireframed low-fi, with a live build status on every feature. Where does a stranger become a Scout? Where does a Scout become a City Ambassador? What's shipped, what's mid-build, what's still on the roadmap. This is the map of the map.</p>
            ...
            <div className="jm-legend">
              <span className="jm-chip live"><span className="d"></span>Live</span>
              <span className="jm-chip building"><span className="d"></span>Building</span>
              <span className="jm-chip planned"><span className="d"></span>Planned</span>
              <span className="jm-chip exploring"><span className="d"></span>Exploring</span>
            </div>
          </header>
