  ...
  return (
    <div className="min-h-screen bg-void">
      ...
      <section className="relative overflow-hidden border-b border-slate2/40 page-top px-4 pb-16 md:px-8 md:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <h1 className="mt-4 max-w-3xl font-display text-4xl font-bold leading-[1.05] tracking-[-0.03em] text-silver md:text-6xl">
            We're building the world's first open atlas of{' '}
            <span className="text-ozone text-glow-ozone">street-level ad media</span>.
          </h1>
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-darkgray md:text-lg">
            OOH Earth is in public beta — community-funded, open-source, and run by a lean core team
            plus a global volunteer network. We're looking for members, engineers and organisers who
            want to make public-space advertising visible, accountable and subvertible.
          </p>
          <div className="mt-7 flex flex-wrap gap-3">
            <a
              href={mailto}
              className="group inline-flex items-center gap-2 border-2 border-ozone bg-ozone px-5 py-3 font-mono text-[11px] font-bold uppercase tracking-[0.25em] text-void transition-colors hover:bg-flare hover:border-flare"
            >
            ...
            <a
              href="#roles"
              className="inline-flex items-center gap-2 border border-slate2 px-5 py-3 font-mono text-[11px] font-bold uppercase tracking-[0.25em] text-silver transition-colors hover:border-ozone hover:text-ozone"
            >
            ...
            {admin && (
              <Link
                to="/careers/admin"
                className="inline-flex items-center gap-2 border border-slate2 px-5 py-3 font-mono text-[11px] font-bold uppercase tracking-[0.25em] text-silver/70 transition-colors hover:border-ozone hover:text-ozone"
              >
        ...
        <div className="mx-auto max-w-5xl">
          <Reveal>
            <div className="flex items-end justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 font-display text-2xl font-bold tracking-[-0.02em] text-silver md:text-3xl">
                  Jobsboard
                </h2>
              </div>
            ...
            <div className="mt-3 flex flex-wrap gap-x-5 gap-y-1 font-mono text-[10px] uppercase tracking-[0.2em] text-dim">
              <span className="flex items-center gap-1.5">
                <span className="h-1.5 w-1.5 bg-[#39FF14]" /> Live role — apply now
              </span>
              <span className="flex items-center gap-1.5">
                <span className="h-1.5 w-1.5 bg-flare" /> Future need — register interest
              </span>
            </div>
          </Reveal>
          <div className="mt-10 space-y-12">
            {CATEGORIES.map((cat) => {
              ...
              const inCat = ROLES.filter((r) => r.category === cat && r.status !== 'draft').sort(
              ...
              return (
                <div key={cat}>
                  <div className="flex items-baseline justify-between gap-3 border-b border-slate2/40 pb-2">
                    <h3 className="font-display text-lg font-semibold tracking-[-0.01em] text-silver">
                      {cat}
                    </h3>
                    <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-dim">
                      {inCat.length} roles
      ...
      <section className="border-b border-slate2/40 px-4 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            ...
            <p className="mt-2 max-w-2xl text-sm text-darkgray">
              We've stopped reading CVs too closely. Some of the best members we know had never
              mapped a thing before their first walk; some of the most decorated never shipped at
              all. The five things below are what really tells us who'll do their best work here —
              and, honestly, who we'll enjoy the ride with.
            </p>
          </Reveal>
            ...
            {LOOK_FOR.map((v, i) => (
              <Reveal key={v.title}>
                <div className="flex h-full gap-4 border border-slate2/50 bg-card/40 p-5">
                  <span className="font-mono text-sm font-black text-ozone">
                    {String(i + 1).padStart(2, '0')}
                  </span>
                  <div>
                    <h3 className="font-display text-base font-semibold tracking-[-0.01em] text-silver">
                      {v.title}
                    </h3>
      ...
      <section className="border-b border-slate2/40 px-4 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            ...
            <p className="mt-2 max-w-2xl text-sm text-darkgray">
              Same standard for a paid contractor and a first-week volunteer. These don't bend.
            </p>
          </Reveal>
      ...
      <section className="border-b border-slate2/40 px-4 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            ...
            <h2 className="mt-2 font-display text-2xl font-bold tracking-[-0.02em] text-silver md:text-3xl">
              Volunteering shouldn't cost you
            </h2>
            <p className="mt-2 max-w-2xl text-sm text-darkgray">
              Most of the network is volunteer-run — but we back our people. Honest support, and no
              false promises of a salary.
            </p>
          </Reveal>
          <div className="mt-8 grid grid-cols-1 gap-px border border-slate2/40 bg-slate2/40 sm:grid-cols-2 lg:grid-cols-4">
            {SUPPORT.map((s) => (
      ...
      <section className="border-b border-slate2/40 px-4 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            <h2 className="font-display text-2xl font-bold tracking-[-0.02em] text-silver md:text-3xl">
              How we hire
            </h2>
      ...
      <section className="px-4 py-20 md:px-8 md:py-28">
        <div className="relative mx-auto max-w-3xl overflow-hidden border border-slate2/60 bg-card/40 p-8 text-center md:p-12">
          ...
          <div className="relative">
            <h2 className="font-display text-3xl font-bold tracking-[-0.02em] text-silver md:text-4xl">
              Don't see your role?
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-darkgray md:text-base">
              You don't need our permission to start. Map an ad near you today — or pitch the role
              you think we're missing. And if you can't give time, funding the movement is its own
              kind of joining.
            </p>
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              <a
                href={mailto}
                className="inline-flex items-center gap-2 border-2 border-ozone bg-ozone px-5 py-3 font-mono text-[11px] font-bold uppercase tracking-[0.25em] text-void transition-colors hover:bg-flare hover:border-flare"
              >
