    ...
    <div className="min-h-screen bg-void text-silver">
      ...
      <main className="page-top mx-auto max-w-6xl px-5 pb-24 md:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-[9px] uppercase tracking-[0.3em] text-ozone">// categories · directories</span>
        </div>
        <h1 className="mt-2 font-display text-3xl font-bold tracking-[-0.02em] md:text-4xl">Category directories</h1>
        <p className="mt-2 max-w-2xl text-[13px] leading-relaxed text-darkgray">
          The public record, split by surface type. Pick a category to browse every logged site of that kind — each
          directory cross-links to all the others.
        </p>

        <Link to="/regions" className="mt-4 inline-flex items-center gap-2 border border-slate2/60 px-3 py-2 font-mono text-[10px] uppercase tracking-[0.2em] text-darkgray transition-colors hover:border-ozone hover:text-ozone">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-[10px] tabular text-dim/50">{String(n).padStart(2, "0")}</span>
                </div>
                ...
                <p className="mt-1.5 flex-1 font-display text-[12px] leading-[1.5] text-darkgray">{c.blurb}</p>
