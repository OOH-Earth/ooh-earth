...
import {
  ...
  CHIP_SPOT_COLORS,
  CHIP_FIELD_COLORS,
} from '@/components/ooh/lab/tokenPresets';
  ...
  return (
    <div className="min-h-screen bg-void grid-bg text-silver">
      ...
      <div className="mx-auto max-w-6xl page-top px-6 pb-12">
        <Breadcrumbs
          items={[{ label: 'Lab', to: '/lab' }, { label: 'Genesis Token' }]}
          className="mb-4"
        />
        ...
        <header className="flex flex-wrap items-baseline gap-x-5 gap-y-2 border-b border-slate2 pb-4">
          <h1 className="text-2xl font-bold uppercase tracking-[0.14em]">
            Genesis <span className="text-ozone">Token</span>
          </h1>
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-silver/50">
            $OOHEX · fungible · ERC-20 · Base · community + governance
          </p>
          <div className="ml-auto flex items-center gap-4 font-mono text-xs uppercase tracking-[0.1em]">
            <Link to="/lab" className="text-silver/40 transition-colors hover:text-ozone">
              ← Lab
            </Link>
        ...
        <div className="mt-5 flex items-start gap-3 border border-ozone/25 bg-ozone/[0.04] px-4 py-3">
          ...
          <p className="font-mono text-[11px] leading-relaxed text-silver/60">
            <span className="text-ozone">$OOHEX · FUNGIBLE COMMUNITY TOKEN</span> — The Genesis
            Token is the liquid, on-chain currency of the OOH Earth commons. Unlike the Genesis Chip
            (a physical, non-fungible cultural artifact you hold), the token is divisible,
            tradeable, and earned. It funds field work, rewards members, and governs the treasury.
            Burned on every transfer, governed by those who hold it.
          </p>
        </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="border border-slate2 bg-card p-5">
              ...
              <p className="mt-3 font-mono text-[11px] leading-relaxed text-silver/55">
                A fungible token has no physical form — so its mark is minted as a chip. Customize
                the ring, edge spots, center field, glyph, and arched text, then export the render
                for DEX listings, wallets, and social.
              </p>
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div>
                  <div className="font-mono text-[9px] uppercase tracking-widest text-ozone">
                    Ring
                  </div>
        ...
        <div className="mt-6 border border-slate2 bg-card p-5">
          ...
          <p className="mt-3 font-mono text-[11px] leading-relaxed text-silver/55">
            "Genesis Token" is a generic crypto term. Several unrelated projects use the word
            "Genesis." Here's how ours is distinct — and what it means for OOH Earth.
          </p>
          <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            <div className="border border-slate2 p-4">
              <div className="font-mono text-[9px] uppercase tracking-widest text-flare">
                Metaplex Genesis (Solana)
              </div>
              <p className="mt-2 font-mono text-[11px] leading-relaxed text-silver/55">
                A launchpad for fair-mint NFT collections on Solana. It's a{' '}
                <span className="text-silver/80">tool</span>, not a token. Our Genesis Token is a
                standalone fungible ERC-20 — no relation to Metaplex's launchpad.
              </p>
            </div>
            <div className="border border-slate2 p-4">
              <div className="font-mono text-[9px] uppercase tracking-widest text-flare">
              ...
              <p className="mt-2 font-mono text-[11px] leading-relaxed text-silver/55">
                A limited NFT pass for the Seeker hardware device. It's a{' '}
                <span className="text-silver/80">non-fungible pass</span>. Our token is fungible and
                open-supply — no device gate, no whitelist.
              </p>
            </div>
            <div className="border border-slate2 p-4">
              <div className="font-mono text-[9px] uppercase tracking-widest text-flare">
              ...
              <p className="mt-2 font-mono text-[11px] leading-relaxed text-silver/55">
                A separate L1 blockchain project sharing the name. Entirely different team, chain,
                and purpose. Not us — no affiliation.
              </p>
            </div>
            <div className="border border-ozone/40 bg-ozone/5 p-4">
              <div className="font-mono text-[9px] uppercase tracking-widest text-ozone">
                OOH Earth — $OOHEX (ours)
              </div>
              <p className="mt-2 font-mono text-[11px] leading-relaxed text-silver/55">
                "Genesis" here marks the <span className="text-silver/80">first supply</span> — the
                genesis allocation that bootstraps the OOH Earth commons treasury. It's a utility +
                governance ERC-20 on Base, paired with the physical Genesis Chip. Not a launchpad,
                not a pass, not another chain's coin.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 border border-slate2 bg-card p-5">
          <div className="flex items-center gap-2">
            ...
            <div className="font-mono text-[11px] uppercase tracking-[0.2em] text-ozone">
              Chip vs Token — two assets, one commons
            </div>
          </div>
            ...
            <table className="w-full border-collapse font-mono text-[11px]">
              <thead>
                <tr className="border-b border-slate2">
                  <th className="px-3 py-2 text-left text-[9px] uppercase tracking-widest text-silver/40">
                    Aspect
                  </th>
                  <th className="px-3 py-2 text-left text-[9px] uppercase tracking-widest text-ozone">
                    $OOHEX Token
                  </th>
                  <th className="px-3 py-2 text-left text-[9px] uppercase tracking-widest text-flare">
                    Genesis Chip
                  </th>
                </tr>
              </thead>
          ...
          <p className="mt-4 font-mono text-[11px] leading-relaxed text-silver/45">
            <span className="text-silver/70">Together:</span> the chip is the artifact you hold —
            scarce, physical, provenance-bearing. The token is the currency you spend and earn —
            liquid, divisible, governance-bearing. The chip gives you a fixed presence vote; the
            token gives you proportional economic say. Both fund the same treasury.
          </p>
        </div>
          ...
          <div className="border border-slate2 bg-card p-5">
            ...
            <div className="mt-3 font-mono text-xs text-silver/60">
              {TOKEN_SPECS.map(([k, v]) => (
                <div
                  key={k}
                  className="flex justify-between gap-3 px-1 py-2 border-b border-slate2/30 last:border-0"
                >
            ...
            <div className="mt-4 space-y-3">
              {TOKEN_DISTRIBUTION.map((d) => (
                <div key={d.label}>
                  ...
                  <p className="mt-1 font-mono text-[9px] leading-relaxed text-silver/40">
                    {d.desc}
                  </p>
                </div>
              ))}
            ...
            {TOKEN_UTILITY.map((u) => {
              ...
              return (
                <div key={u.title} className="border border-slate2 p-4">
                  ...
                  <p className="mt-1.5 font-mono text-[10px] leading-relaxed text-silver/50">
                    {u.desc}
                  </p>
                </div>
              );
        ...
        <div className="mt-6 border border-ozone/30 bg-card p-5">
          <div className="flex items-center gap-2">
            ...
            <div className="font-mono text-[11px] uppercase tracking-[0.2em] text-ozone">
              The cycle · earn → trade → govern → stake
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2 font-mono text-[10px] uppercase tracking-wider text-silver/65">
            ...
            <ArrowRight className="h-3 w-3 text-ozone" />
            <span className="border border-flare/40 bg-flare/5 px-2 py-1 text-flare">
              1% burned
            </span>
          </div>
        </div>
        ...
        <div className="mt-6 border border-slate2 bg-card p-5">
          ...
          <div className="mt-4 font-mono text-xs text-silver/60">
            {REWARD_TIERS.map((r) => (
              <div
                key={r.action}
                className="flex items-center justify-between gap-3 px-1 py-2.5 border-b border-slate2/30 last:border-0"
              >
          ...
          <p className="mt-3 font-mono text-[11px] leading-relaxed text-silver/45">
            Rewards mint from the 20% field-rewards pool. When the pool depletes, the DAO votes to
            replenish from the treasury — the commons sustains its own field force.
          </p>
        </div>
        ...
        <div className="mt-6 border border-ozone/30 bg-card p-5">
          <div className="flex items-center gap-2">
            ...
            <div className="font-mono text-[11px] uppercase tracking-[0.2em] text-ozone">
              Project value · why the token exists
            </div>
          </div>
          <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
            <div className="border border-slate2 p-4">
              ...
              <p className="mt-2 font-mono text-[11px] leading-relaxed text-silver/55">
                Token liquidity + treasury allocation funds the field work — maps, legal defense,
                open-source code. The commons is self-sustaining.
              </p>
            </div>
            <div className="border border-slate2 p-4">
              <div className="font-mono text-[9px] uppercase tracking-widest text-ozone">
              ...
              <p className="mt-2 font-mono text-[11px] leading-relaxed text-silver/55">
                Proof-of-presence mining turns documentation into income. Members in under-mapped
                cities earn real value for filling blank spots — the map grows where it's needed
                most.
              </p>
            </div>
            <div className="border border-slate2 p-4">
              ...
              <p className="mt-2 font-mono text-[11px] leading-relaxed text-silver/55">
                Those who hold and stake the token decide where the treasury flows — which cities
                get mapped, which legal cases backed, which tools built. Quadratic voting keeps it
                fair.
              </p>
            </div>
          </div>
          <div className="mt-4 border border-slate2 bg-void p-4">
            ...
            <p className="mt-3 font-mono text-[11px] leading-relaxed text-silver/45">
              The chip anchors provenance; the token fuels the flywheel. Together they create a
              self-reinforcing loop: documentation generates value, value funds more documentation,
              the commons grows.
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 border border-flare/30 bg-flare/[0.03] px-4 py-3">
          <p className="font-mono text-[10px] leading-relaxed text-silver/50">
            <span className="text-flare">NOT A SECURITY.</span> $OOHEX is a utility + governance
            token. It grants no equity, no dividend, no profit-sharing. Its value derives from
            ecosystem use (rewards, governance, access), not from the expectation of profit from the
            efforts of others. The token is burned on transfer (deflationary), not promised to
            appreciate. Read the full disclaimer on the Zora page.
          </p>
        </div>
        ...
        <div className="mt-6 border border-slate2 bg-card p-5">
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
            ...
            >
              ...
              <div>
                <div className="text-sm font-bold">Genesis Chip</div>
                <div className="font-mono text-[10px] text-silver/50">
                  Physical artifact · 1:1 twin
                </div>
              </div>
            ...
            >
              ...
              <div>
                <div className="text-sm font-bold">NFT Creator</div>
                <div className="font-mono text-[10px] text-silver/50">Subvertising slab studio</div>
              </div>
              <ArrowRight className="ml-auto h-4 w-4 text-silver/30 group-hover:text-ozone" />
            </Link>
            <Link
