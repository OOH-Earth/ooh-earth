    ...
    <div className="relative min-h-screen bg-void">
      ...
      <section className="page-top border-b border-slate2/40 px-5 pb-14 md:px-8 md:pb-20">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-ozone">
          // On-chain resistance · Zora + Base + Solana
        </span>
        ...
        <p className="mt-4 max-w-xl font-display text-sm leading-[1.5] text-darkgray">
          Live market telemetry for the on-chain layer of OOH Earth — content coins, creator coins,
          and the lunar cycles that frame each action window. Real data, streamed from the chain.
        </p>
        <div className="mt-6 flex items-center gap-3">
          <WalletButton chain="evm" />
          <span className="font-mono text-[9px] uppercase tracking-[0.25em] text-dim">
            // connect to mint content coins on Zora
          </span>
        </div>
      </section>
