...
const statusColor = (s) =>
  s === 'verified' ? 'text-brand-green' : s === 'rejected' ? 'text-flare' : 'text-ozone';
      ...
      <div className="mx-auto max-w-6xl page-top px-6 pb-12">
        ...
        <header className="flex flex-wrap items-baseline gap-x-5 gap-y-2 border-b border-slate2 pb-4">
          <h1 className="text-2xl font-bold uppercase tracking-[0.14em]">
            Desktop <span className="text-ozone">Console</span>
          </h1>
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-silver/50">
            Field-ops desktop app · prototype
          </p>
        ...
        <div className="mt-6 overflow-hidden border border-slate2 bg-card">
          <div className="flex items-center gap-2 border-b border-slate2 bg-void px-3 py-2">
            ...
            <span className="ml-3 font-mono text-[10px] uppercase tracking-[0.2em] text-silver/50">
              OOH · Field Console
            </span>
            <span className="ml-auto flex items-center gap-1 font-mono text-[9px] text-brand-green">
          ...
          <div className="grid min-h-[420px] grid-cols-[160px_1fr]">
            <div className="border-r border-slate2 bg-void/60 p-3">
              {NAV_ITEMS.map((n) => (
                <div
                  key={n.label}
                  className={`flex items-center gap-2 px-2 py-2 font-mono text-[10px] uppercase tracking-wider ${n.active ? 'border-l-2 border-ozone bg-ozone/5 text-ozone' : 'text-silver/50'}`}
                >
            ...
            <div className="p-4">
              ...
              <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
                ...
                <div className="border border-dashed border-ozone/40 p-3 text-center">
                  ...
                  <div className="mt-2 font-mono text-[9px] uppercase tracking-widest text-silver/50">
                    Drop CSV / KML
                  </div>
                </div>
              </div>
        ...
        <div className="mt-6 border border-slate2 bg-card p-5">
          ...
          <p className="mt-4 font-mono text-[11px] leading-relaxed text-silver/50">
            A thick-client for field ops: moderate submissions in bulk, import KML/CSV spot data,
            watch the treasury, and overlay the offense map on a big screen. Offline-first — caches
            every report and syncs over Web7 on reconnect.
          </p>
        </div>
