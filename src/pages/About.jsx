        ...
        <section className="relative flex min-h-[78vh] items-end overflow-hidden">
          ...
          <div className="relative px-5 pb-16 md:px-8 md:pb-24">
            ...
            <p className="mt-5 max-w-xl font-display text-sm font-normal leading-[1.4] text-darkgray md:text-base">
              An adbusting platform for Out-of-Home (OOH) advertising. Union-made by subvertisers
              and advertising-industry war veterans.
            </p>
          </div>
        </section>
        ...
        <section id="manifesto" className="border-t border-slate2/40 bg-void">
          <div className="px-5 py-16 md:px-8 md:py-24">
            <div className="mx-auto max-w-3xl">
              <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-ozone">
                // Section 01 — Manifesto for world revolution
              </span>
              <div className="mt-6 space-y-5 font-display text-lg font-normal leading-[1.5] text-silver/85 md:text-xl md:leading-[1.45]">
                <p>
                  In every corner of our cities, corporate advertising has come to dominate. It
                  commands our streets, our skylines, our public spaces. Billboards, bus stops,
                  digital screens — they scream at us, feeding us a constant stream of messages we
                  never asked for, promising products we don't need, and dictating desires that
                  aren't our own.
                </p>
                <p>
                  But public space should belong to the public. It should reflect the diversity,
                  creativity, and collective values of the people who live there — not the profit
                  motives of corporations. Our streets deserve better than to be tools for corporate
                  gain. And so do we.
                </p>
                <p className="font-bold text-silver">
                  OOH Earth is a call to reclaim — our streets and our skies, our senses and our
                  minds. We will not passively accept the corporate vision forced upon us. Together,
                  we will rewrite the rules, creating cities that honor the people who inhabit them
                  — not the corporations who seek to monetize them.
                </p>
                <p>
                  It's time for a new vision of public space: one free from corporate interests, and
                  full of the people's voices.
                </p>
                <p className="font-bold text-ozone">Join us. Stand with us. Build with us.</p>
              </div>
              <div className="mt-8 border-t border-slate2/40 pt-6">
                <p className="font-display text-base font-bold tracking-[-0.01em] text-silver">
                  OOH Earth
                </p>
                <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-dim">
                  For Cities That Belong to People
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="border-t border-slate2/40 bg-card">
          <div className="px-5 py-16 md:px-8 md:py-20">
            <div className="mx-auto max-w-4xl text-center">
              <div className="font-display text-6xl font-black leading-none tracking-[-0.03em] text-ozone md:text-8xl">
                2%
              </div>
              ...
              <p className="mt-2 font-mono text-[10px] uppercase tracking-[0.3em] text-dim">
        ...
        <section className="border-t border-slate2/40 bg-void">
          <div className="px-5 py-16 md:px-8 md:py-24">
            <div className="flex items-end justify-between border-b border-slate2/40 pb-6">
              ...
              <Link
                to="/map"
                className="hidden items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.25em] text-silver/60 hover:text-ozone sm:flex"
              >
            ...
            <div className="mt-8 grid grid-cols-2 gap-px border border-slate2/40 bg-slate2/40 sm:grid-cols-3 lg:grid-cols-4">
              {GALLERY.map((src, i) => (
                <div key={i} className="aspect-square overflow-hidden bg-void">
                  <Image
                    src={src}
                    alt={`OOH field intervention ${i + 1}`}
          ...
          <div className="px-5 py-16 md:px-8 md:py-24">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mt-4 max-w-md font-display text-sm font-normal leading-[1.4] text-darkgray">
                By funding OOH Earth, you support a platform that fights corporate overreach, backs
                grassroots artists, and inspires real change in public spaces. Target: $10,000 for
                growth, platform development, and community outreach.
              </p>
