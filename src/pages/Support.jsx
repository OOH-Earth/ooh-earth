        ...
        <section className="px-5 pb-10 md:px-8">
          <div className="mx-auto max-w-5xl">
            ...
            <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-ozone">
              // Support · Help & fund the resistance
            </span>
            ...
            <p className="mt-4 max-w-xl font-display text-sm leading-[1.5] text-darkgray md:text-base">
              Get answers, reach the agency, or back the offensive. OOH Earth is open-source,
              union-made, and community-funded — every transmission counts.
            </p>
          </div>
        </section>
            ...
            <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-2 font-mono text-[11px] leading-relaxed text-silver/50">
                  Drop a message and we'll reply by email. For pledges or partnership, use the same
                  form — it logs straight to the agency inbox.
                </p>
                <div className="mt-5">
                  <ContactForm />
                </div>
              ...
              <div>
                ...
                <div className="mt-5 grid grid-cols-2 gap-px border border-slate2/60 bg-slate2/40">
                  {CHANNELS.map((c) => (
                    ...
                    >
                      ...
                      <span className="font-mono text-[11px] uppercase tracking-[0.15em] text-darkgray transition-colors group-hover:text-ozone">
                        {c.label}
                      </span>
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  <Link
                    to="/guides"
                    className="inline-flex items-center gap-2 border border-slate2 px-4 py-2.5 font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-darkgray transition-colors hover:border-ozone hover:text-ozone"
                  >
        ...
        <section className="border-t border-slate2/40">
          <div className="px-5 py-12 md:px-8">
            <div className="mx-auto max-w-3xl">
              ...
              <h2 className="mt-2 mb-5 font-display text-2xl font-bold tracking-[-0.02em]">
                Frequently asked
              </h2>
              <SupportFaq />
            </div>
            ...
            <div className="mx-auto max-w-5xl">
              <div className="flex flex-wrap items-baseline justify-between gap-4">
                <div>
                  ...
                  <h2 className="mt-2 font-display text-2xl font-bold tracking-[-0.02em] md:text-3xl">
                    Back the movement
                  </h2>
                </div>
                <Link
              ...
              <p className="mt-2 max-w-lg font-mono text-[11px] leading-relaxed text-silver/50">
                Card donations run through Stripe; crypto lands directly in the treasury. No
                intermediaries, full transparency on the treasury console.
              </p>
