  ...
  return (
    <div className="min-h-screen bg-void grid-bg text-silver">
      ...
      <div className="mx-auto max-w-6xl page-top px-6 pb-12">
        <Breadcrumbs items={[{ label: "Lab", to: "/lab" }, { label: "Hex Engine Poster" }]} className="mb-4" />
        <header className="flex flex-wrap items-baseline gap-4 border-b border-slate2 pb-4">
          ...
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-silver/50">The 3D Ba Gua sphere · the city is the interface</p>
          <div className="ml-auto flex items-center gap-4 font-mono text-xs uppercase tracking-[0.1em]">
            <Link to="/lab/coin-poster" className="text-ozone transition-colors hover:text-ozone/70">Coin Poster →</Link>
