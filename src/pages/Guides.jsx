      ...
      <main className="mx-auto max-w-5xl px-5 pb-24 page-top md:px-8">
        <header className="border-b border-slate2/40 pb-10">
          ...
          <p className="mt-4 max-w-2xl font-body text-sm leading-[1.6] text-darkgray">
            A start-to-finish manual for operating the OOH Street Art & Adbusting Maps app — from
            first landing to running the dashboard — followed by an honest capability matrix showing
            exactly what is live, what is gated, and where the gaps remain.
          </p>
        </header>
        ...
        <div className="mt-6 space-y-3">
          <Panel
            ...
            icon={Compass}
            idx="01"
            title="User journey · beginning to end"
            status="9 steps"
          >
            <JourneySteps />
          </Panel>
          ...
          <Panel
            ...
            icon={AlertTriangle}
            idx="02"
            title="Capability status & gaps"
            status="actuals"
          >
            <p className="mb-4 font-body text-sm leading-[1.55] text-darkgray">
              Where the build stands against the mission. Live = shipping now; Beta = functional but
              incomplete; Gated = requires published HTTPS; Gap = not yet wired or awaiting data.
            </p>
            <StatusMatrix />
          </Panel>
        </div>
        ...
        <footer className="mt-8 border-t border-slate2/40 pt-6">
          <p className="font-mono text-[9px] uppercase tracking-[0.3em] text-dim">
            // open-source · union-made · field manual v1
          </p>
        </footer>
      </main>
    </div>
