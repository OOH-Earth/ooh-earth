        ...
        <div className="mt-6">
          <div className="flex items-start gap-3 border border-brand-green/40 bg-brand-green/[0.05] p-4">
            ...
            <p className="font-mono text-[11px] leading-relaxed text-silver/70">
              If an account exists for <span className="text-silver">{email}</span>, a reset link is
              on its way. Check your inbox — and spam.
            </p>
          </div>
          <Link
            to="/login"
            className="mt-6 flex items-center justify-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-dim transition-colors hover:text-ozone"
          >
