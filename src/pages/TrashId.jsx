    ...
    <div className="min-h-screen bg-void">
      ...
      <main className="page-top mx-auto max-w-3xl px-5 pb-24 md:px-8">
        <div className="flex flex-col gap-1">
          <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-ozone">// Field tool · Trash attribution</span>
          <h1 className="font-display text-3xl font-black uppercase tracking-tight2 text-silver md:text-5xl">Photograph the dump.<br />Name the brand.</h1>
          <p className="mt-2 max-w-xl font-display text-sm leading-relaxed text-darkgray">
            Snap discarded waste in the field. Vision analysis IDs every visible brand, estimates piece counts and materials, and scores corporate accountability for the mess.
          </p>
        </div>

        <div className="mt-8 border border-slate2/60 bg-card p-4">
          <div className="mb-3 font-mono text-[10px] uppercase tracking-[0.25em] text-dim">// Capture evidence</div>
          <label className="flex cursor-pointer flex-col items-center justify-center gap-3 border-2 border-dashed border-slate2 bg-void p-8 transition-colors hover:border-ozone">
            {preview ? (
              ...
              <>
                ...
                <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-darkgray">Take photo or drop image</span>
              </>
            )}
            <input
              type="file"
        ...
        {loading && (
          <div className="mt-6 flex flex-col items-center gap-3 border border-slate2/60 bg-card p-12">
            ...
            <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-dim">Identifying brands…</span>
          </div>
        )}
