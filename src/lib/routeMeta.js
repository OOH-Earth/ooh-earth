...
export const META = {
  ...
  "/support":       { title: "Support — OOH Earth", desc: "Get help, report issues, and join the member network. Field support for the OOH Earth community.", image: OG_IMAGES.default },
  ...
  "/operative":     { title: "Member Profile — OOH Earth", desc: "Your field profile — handle, tier, badges, and field credits.", image: OG_IMAGES.default },
  "/guides":        { title: "Guides — OOH Earth", desc: "Field guides for members — how to report, bust, mint, and organize.", image: OG_IMAGES.default },
  "/field-id":      { title: "Field ID — OOH Earth", desc: "Your field credential — printable ID card for members on the ground.", image: OG_IMAGES.default },
  ...
  "/journey":       { title: "Journey Map — OOH Earth", desc: "The member journey — from first report to veteran field reporter.", image: OG_IMAGES.default },
  ...
  "/careers":       { title: "Careers — OOH Earth", desc: "Join the OOH Earth collective — open roles for members, researchers, and developers.", image: OG_IMAGES.default },
  ...
  "/account":       { title: "Account — OOH Earth", desc: "Manage your OOH Earth account and member profile.", image: OG_IMAGES.default },
  "/dashboard":     { title: "Console — OOH Earth", desc: "Member console — field stats, locations, mints, and activity.", image: OG_IMAGES.default },
  ...
  "/login":         { title: "Sign In — OOH Earth", desc: "Sign in to your OOH Earth member account.", image: OG_IMAGES.default },
  "/register":      { title: "Register — OOH Earth", desc: "Join the OOH Earth member network.", image: OG_IMAGES.default },
