...
export const OOHEX = (() => {
  const TRI = {
    111: {
      ...
      layer: 'Identity',
      verb: 'SIGN',
      verbDesc: 'authenticate & authorize',
    },
    '000': {
      pinyin: 'Kūn',
      el: 'Earth',
      sym: '☷',
      layer: 'DAO / Governance',
      verb: 'BUILD',
      verbDesc: 'propose, vote, govern',
    },
    100: {
      pinyin: 'Zhèn',
      el: 'Thunder',
      sym: '☳',
      layer: 'Maps / Discovery',
      verb: 'MOVE',
      verbDesc: 'navigate the city layer',
    },
    '010': {
      pinyin: 'Kǎn',
      el: 'Water',
    ...
    '001': {
      ...
      layer: 'Assets',
      verb: 'VERIFY',
      verbDesc: 'prove presence & provenance',
    },
    '011': {
      pinyin: 'Xùn',
      el: 'Wind',
      ...
      layer: 'Communities',
      verb: 'DISCOVER',
      verbDesc: 'surface nearby activity',
    },
    101: {
      pinyin: 'Lí',
      el: 'Fire',
      ...
      layer: 'Campaigns',
      verb: 'CREATE',
      verbDesc: 'publish to the commons',
    },
    110: {
      pinyin: 'Duì',
      el: 'Lake',
  ...
  const NAMES = {
    ...
    9: ['Xiǎo Chù', 'Small Taming'],
    10: ['Lǚ', 'Treading'],
    11: ['Tài', 'Peace'],
    12: ['Pǐ', 'Standstill'],
    13: ['Tóng Rén', 'Fellowship'],
    14: ['Dà Yǒu', 'Great Possession'],
    15: ['Qiān', 'Modesty'],
    16: ['Yù', 'Enthusiasm'],
    17: ['Suí', 'Following'],
    18: ['Gǔ', 'Work on the Decayed'],
    19: ['Lín', 'Approach'],
