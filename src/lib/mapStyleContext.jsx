...
export const MAP_STYLES = [
  {
    ...
    subdomains: 'abcd',
    maxZoom: 20,
    glStyle: 'https://basemaps.cartocdn.com/gl/dark-matter-gl-style/style.json',
    bg: '#000',
  },
  {
    id: 'light',
    ...
    subdomains: 'abcd',
    maxZoom: 20,
    glStyle: 'https://basemaps.cartocdn.com/gl/positron-gl-style/style.json',
    bg: '#f5f5f5',
  },
  {
    id: 'voyager',
    ...
    subdomains: 'abcd',
    maxZoom: 20,
    glStyle: 'https://basemaps.cartocdn.com/gl/voyager-gl-style/style.json',
    bg: '#f4f1ea',
  },
  {
    id: 'satellite',
...
export function MapStyleProvider({ children }) {
  ...
  return (
    <MapStyleContext.Provider
      value={{ styleId, style: byId(styleId), setStyleId: setStyle, styles: MAP_STYLES }}
    >
      {children}
    </MapStyleContext.Provider>
  );
...
export function useMapStyle() {
  ...
  if (!ctx)
    return { styleId: 'dark', style: byId('dark'), setStyleId: () => {}, styles: MAP_STYLES };
  return ctx;
}
