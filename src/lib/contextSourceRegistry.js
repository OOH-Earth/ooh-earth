...
export const CONTEXT_SOURCE_REGISTRY = Object.freeze([
  ...
  {
    name: 'OOH Earth reviewed OOH-significance registry',
    url: 'https://oohearth.app',
    category: 'curated famous advertising context',
    status: SOURCE_STATUSES.APPROVED_FREE,
    coverage: 'Small reviewed set of source-backed OOH-significant places',
    license: 'OOH Earth factual metadata; each record retains its source attribution',
    attribution: 'OOH Earth plus record-specific source attribution',
    rateLimits: 'No external service dependency',
    caching: 'Static release artifact; review records in Git history',
    commercialUse: 'Record-specific source terms must be respected; no media included',
