...
import {
  BADGES, QUESTS, levelFromXp, pointsForReport,
  isToday, isThisWeek, periodKey,
...
export function useGamification() {
  ...
  const questStatus = stats ? QUESTS.map(q => {
  ...
  return {
    user, stats, level,
    earnedBadges, allBadges: BADGES,
    questStatus, claimQuest, claiming,
